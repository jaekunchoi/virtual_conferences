...
#        post :create, {:industry => { "name" => "invalid value" }}, valid_session
#        assigns(:industry).should be_a_new(Industry)
#      end
#
...
#        Industry.any_instance.should_receive(:update).with({ "name" => "MyString" })
#        put :update, {:id => industry.to_param, :industry => { "name" => "MyString" }}, valid_session
#      end
#
#      it "assigns the requested industry as @industry" do
#        industry = Industry.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Industry.any_instance.stub(:save).and_return(false)
#        put :update, {:id => industry.to_param, :industry => { "name" => "invalid value" }}, valid_session
#        assigns(:industry).should eq(industry)
#      end
#

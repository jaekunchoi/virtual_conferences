...
#  let(:valid_attributes) { { "from_user" => "1" } }
#
...
#        post :create, {:chat => { "from_user" => "invalid value" }}, valid_session
#        assigns(:chat).should be_a_new(Chat)
#      end
#
...
#        Chat.any_instance.should_receive(:update).with({ "from_user" => "1" })
#        put :update, {:id => chat.to_param, :chat => { "from_user" => "1" }}, valid_session
#      end
#
#      it "assigns the requested chat as @chat" do
#        chat = Chat.create! valid_attributes
...
#        # Trigger the behavior that occurs when invalid params are submitted
#        Chat.any_instance.stub(:save).and_return(false)
#        put :update, {:id => chat.to_param, :chat => { "from_user" => "invalid value" }}, valid_session
#        assigns(:chat).should eq(chat)
#      end
#
